"""Sensor tests."""
from custom_components.zeversolar_local.const import DOMAIN, CONF_SERIAL_NO
from custom_components.zeversolar_local.sensor import Inverter, Sensor, ZeverSolarSensor, async_setup_entry
from custom_components.zeversolar_local.coordinator import ZeversolarApiCoordinator, ZeverSolarApiClient
...
async def test_async_setup_entry(hass):
    ...
    with patch("custom_components.zeversolar_local.zeversolar_api.zs.inverter_id") as api_mock_inverter:
        api_mock_inverter.return_value = serial_number

        with patch("custom_components.zeversolar_local.zeversolar_api.zs.solardata") as api_mock_solardata:
...
async def test_async_setup_entry_coordinator_update_fails_with_timeout(hass):
    with pytest.raises(UpdateFailed):
        ...
        with patch("custom_components.zeversolar_local.zeversolar_api.zs.solardata") as api_mock_solardata_fail:
