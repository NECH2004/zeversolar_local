...
from zeversolarlocal.api import ZeverTimeout, ZeverError
    ...
    async def async_step_user(self, user_input=None):
        ...
        if user_input is not None:
            ...
            try:
                ...
                _LOGGER.debug("fetching ZeverSolar inverter id falied - %s", exception)
                ...
                _LOGGER.debug(
                    "fetching ZeverSolar inverter id falied witch general exception - %s",
                    exception,
                )
                return self.async_abort(reason="invalid_inverter")
